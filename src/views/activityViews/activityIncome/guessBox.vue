...
<template>
  <sub-page>
    <main-card>
      <!-- 头部数据 -->
      <header-datas class="head-info" :sumInfo="sumInfo" :exists="['buyBox', 'boxConsume', 'boxPercent', 'boxDivide']"> </header-datas>
      <!-- 轮数切换 -->
      ...
      <my-table class="mytable" style="height: auto">
        <el-table :data="tableData" style="width: 100%" header-row-class-name="table-header">
          ...
          <el-table-column prop="eprice" label="宝箱" min-width="120" align="center" header-align="center"> </el-table-column>
          <el-table-column prop="box_count" label="价格" min-width="120" align="center" header-align="center"></el-table-column>
...
import { getBoxListData } from '@/api/setting/activityIncome/activityIncomeData';
...
export default {
  ...
  created() {
    ...
    this.downLoadURL = `${BASEURL}/reportFormsHm/findReportInfo?splid=${liveId}&report_type=kbx_report`;
  },
  methods: {
