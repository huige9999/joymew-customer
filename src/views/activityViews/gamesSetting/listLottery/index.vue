    ...
    <main-card>
        ...
        <div class="form-box">
          ...
          >
            ...
            <el-form-item label="中奖奖项">
              <el-select
                v-model="queryInfo.querySelectAwardType"
                placeholder="全部"
                max-width="100"
              >
                <el-option
                  v-for="item in queryInfo.queryAwardTypes"
                  :key="item.id"
                  :label="item.lable"
                  :value="item.id"
                ></el-option>
            ...
            <el-form-item>
              <el-button
                min-width="200"
                type="primary"
                @click="onSubmit(queryInfo.queryUsername, queryInfo.querySelectAwardType)"
              >
                查询
              </el-button>
            </el-form-item>
            ...
            >
              <template slot-scope="scope">
                ...
                <el-button
                  ...
                  type="danger"
                  icon="el-icon-delete"
                  @click="confirmDelateUser(scope.row.awardid)"
                >
                  删除
                </el-button>
              </template>
        ...
        <div class="addUser-dialog-container">
          ...
          <div class="form-box">
            ...
            >
              <el-button
                type="primary"
                @click="saveAdd(username, selectedAwardType)"
                v-loading="isLoading"
              >
                保存
              </el-button>
      ...
      <my-dialog :show="isShowImportDialog">
        <div class="import-dialog-container">
          ...
          >
            <img
              src="@/assets/image/importList.png"
              alt=""
              width="34"
              height="29"
            />
        ...
        <div class="editUser-dialog-container">
          ...
          <div class="form-box">
            <div class="username">
              ...
              <el-input
                style="margin-left: 65px"
                v-model="editDialogData.editUsername"
                placeholder="请输入内容"
              ></el-input>
            </div>
            <div class="isNeiding">
            ...
            <div
              class="select-award"
              v-show="editDialogData.editIsNeiding"
            >
              <div class="title">中奖奖项</div>
              <el-select
                style="margin-left: 45px"
      ...
      <!-- 生成数字弹出框 -->
      <generateNumber ref="generateNumberRef" @refreshList="initData"/>
    </main-card>
  </sub-page>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    requestCustomData() {
      ...
      this.awardTypes.splice(0);
      this.queryInfo.queryAwardTypes.splice(0);
    ...
    showGenerateNumDialog() {
      this.$refs.generateNumberRef.showDialog();
    },
    //---------------------------
    /* 显示添加用户弹出框 */
    //   number() {
