<template>
    <sub-page>
        <main-card v-loading="loading">
            <card-top-info title="猜明星游戏新增设置"></card-top-info>
            <div class="wrap">
...
<el-table-column prop="answer" label="答案" min-width="120" align="center" header-align="center"></el-table-column>
<el-table-column prop="begin" label="最开始展示" min-width="120" align="center" header-align="center"></el-table-column>
<el-table-column prop="firstTip" label="第一次提示" min-width="120" align="center" header-align="center"></el-table-column>
<el-table-column prop="secondTip" label="第二次提示" min-width="120" align="center" header-align="center"></el-table-column>
<el-table-column label="操作" min-width="120" align="center" header-align="center">
    <template slot-scope="scope">
        ...
        <main-card>
            <card-top-info title="猜明星自定义设置">
            </card-top-info>
            <div class="item-list">
                <CheckItem :itemInfo="item" v-for="item in itemList" :key="item.star_id"
...
import { reqGetGuessStar, saveGuessStar } from '@/api/gameSetting/index';
...
export default {
  ...
  methods: {
    ...
    async initData() {
      this.loading = true;
      // 获取游戏数据
      const res = await reqGetGuessStar();
      // 获取游戏配置数据
    ...
    async confirm(isReset) {
      try {
        ...
        const res = await saveGuessStar(valueStr);
        this.loading = false;
        console.log(res);
        if (isReset !== 'reset') {
          this.$message.success('保存成功!');
