<template>
  <sub-page>
    <div class="award-setting-contaienr">
      <main-card>
        <card-top-info title="同庆楼奖项设置"></card-top-info>
...
import { tqlCouponList } from '@/api/tql/gameSetting';
import myDialog from '@/components/myDialog';
import request from '@/utils/request';
import tqlCouponItem from './TQL/miniGameAward/components/tqlCouponItem';
